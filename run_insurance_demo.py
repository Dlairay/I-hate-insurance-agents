...
class InsuranceDemo:
    ...
    def run(self):
        ...
        print("\n💡 FEATURES:")
        print("   • AI-powered questionnaire with smart help")
        print("   • 5 insurance companies with different products")
        print("   • Real-time quote aggregation")
        print("   • Personalized recommendations")
        print("   • 100+ sample customers in database")
        print("\n🎮 HOW TO USE:")
        ...
        print("   4. Get personalized quotes from multiple companies")
